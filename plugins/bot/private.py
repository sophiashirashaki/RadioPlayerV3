...
HOME_TEXT = "[👋🏻](https://telegra.ph/file/674cd255fe46e535aad3d.jpg) **Hi [{}](tg://user?id={})**,\n\nI'm **Rikka Music V3.0** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @erosei_1 😉!"
HELP_TEXT = """
💡 --**Setting Up**--:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.lower() == "replay":
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/projectsupdates"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/Alvin_Image_Editor_Group),
            ],
            [
                InlineKeyboardButton("CHANNEL MUSIC", url="https://t.me/KumpulanMusicRandom"),
                InlineKeyboardButton("CREATOR", url="https://t.me/erosei_1"),
            ],
            [
...
async def start(client, message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="https://telegra.ph/file/674cd255fe46e535aad3d.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="https://telegra.ph/file/674cd255fe46e535aad3d.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
